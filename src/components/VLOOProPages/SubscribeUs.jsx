...
export default function SubscribeUs() {
  return (
    <div className="mb-4 flex flex-col items-center justify-center gap-[20px] rounded-[10px] border border-[#DEDEDE] bg-white px-[10px] py-[50px] sm:mb-8 md:flex-row md:gap-[197px] md:px-[70px]">
