...
export default function SubscribeUs() {
  return (
    <div className="mb-4 flex flex-col items-center justify-center gap-[20px] md:gap-[197px] rounded-[10px] border border-[#DEDEDE] bg-white px-[10px] py-[50px] sm:mb-8 md:flex-row md:px-[70px]">
      <div className="w-[100%] lg:w-[600px]">
        <p className="mb-[35px] text-[55px] font-bold leading-[80px] text-[#0A2A3C] md:text-[60px]">
      ...
      <div className="w-[100%] md:w-[552px] md:ml-4 ml-0">
        ...
        <div className="flex items-center">
          <input
            ...
            className="w-[296px] rounded-bl-[10px] rounded-tl-[10px] border border-[#006988] bg-[#F3F3F3] p-4 placeholder-[#77808B] focus:outline-none focus:ring-0"
          />
