...
const SpacesCarousel = () => {
    ...
    return (
        <div className="bg-[#E6F7FB] p-8 rounded-3xl mt-8">
            <h2 className="text-xl lg:text-[48px] font-bold text-[#0091B6] text-center">
                Spaces <span className="text-[#0B2A3B]">you might be interested in</span>
            </h2>
            <p className="text-center text-[#757575] mb-6 font-normal text-[24px] mt-4">See the space that are most recommended</p>
