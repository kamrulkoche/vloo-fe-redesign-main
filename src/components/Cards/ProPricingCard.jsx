...
const ProPricingCard = ({
  ...
  return (
    <div
      className={`flex h-full w-[70%] flex-col justify-between rounded-lg shadow-lg md:w-[410px] ${textColor}`}
    >
      {/* Top Section */}
      <div
        className={`rounded-[5px] p-6 ${topBg} ${
          planName === "Basic" ? "pb-[40px]" : ""
        }`}
      >
        <div
          className={`mb-4 flex justify-between text-[24px] font-[400] leading-[28.8px] ${topText}`}
        >
          {planName}
          {planName !== "Basic" && (
            <>
              ...
              <p className="ml-[10px] mt-[5px] h-[18px] w-[151px] rounded-[5px] bg-[#00A481] text-center text-[10px] font-[600] leading-[14px] text-white md:ml-[10px] md:mt-[5px] md:w-[101px]">
                Save 90 NOK/Year
              </p>
            </>
          )}
        ...
        <p className={`mb-6 text-[32px] font-[500] leading-[44px] ${topText}`}>
          {adjustedPrice}
          {adjustedPrice !== "Free" && (
      ...
      {/* Benefits Section */}
      <div className={`p-6 ${planName === "Basic" ? "pt-[4px]" : ""}`}>
        <div>
          <div className={`${adjustedPrice === "Free" ? "mt-[20px]" : ""}`}>
        ...
        {/* Button */}
        <button
          className={`w-full rounded px-6 py-2 text-[16px] font-[600] ${buttonTextBg} ${buttonBg}`}
        >
          {buttonText}
        </button>
      </div>
